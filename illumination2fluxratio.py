...
# Define file paths for filters and spectra:
...
# Planet parameters from runs (these should match the sims from the ringed_planet_illum* runs):
RPLANET    = 69911 * u.km # planet radius
SEPARATION = 5.2   * u.AU # planet semi-major axis

# Ring parameters from runs:
...
roman_filter     = "1" # Roman filter name (1, 3C, 4, 4C) -- UPDATE FILTER NAME BEFORE RUNNING to match filter file of choice
...
RUN_DIRS = [
        Path("/Users/shasler/Documents/Projects/Roman/fraction_lit_output/for_paper/upsAnd_newTrueAnom/obl90_phi0/"),
            ]
